...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        main_visited_store.layoutManager=LinearLayoutManager(applicationContext,LinearLayoutManager.VERTICAL,false)
        ...
        adapter.itemclicklistener=object:main_visited_adapter.OnItemClick{
            override fun itemclick(
                ...
                map_Intent.putExtra("store",data) //하단에 보여줄 데이터 전송
                map_Intent.putExtra("data",storeVisitedList) //인텐트에 데이터 전송
