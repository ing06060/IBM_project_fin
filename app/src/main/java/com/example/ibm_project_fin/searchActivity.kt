...
class searchActivity : AppCompatActivity() {
    ...
    fun get_search_store(data:String):ArrayList<StoreData>{
        ...
        result.add(StoreData("스타벅스 금천독산점", "서울특별시 금천구 독산동 291-1","1522-3232", LatLng(37.469371,126.895700),622.10,1,0,0,0,1.4))
        result.add(StoreData("스타벅스 독산사거리점","서울특별시 금천구 159-23 영진빌딩","1522-3232",LatLng(37.473584,126.898172),1050.0,1,0,0,0,2.0))
        result.add(StoreData("스타벅스 광명하안점","경기도 광명시 하안3동 범안로 1060","1522-3232",LatLng(37.462998,126.880698),874.29,1,0,0,0,1.2))
        result.add(StoreData("스타벅스  W-Mall점","서울특별시 금천구 가산동 디지털로 188","1522-3232",LatLng(37.478388, 126.887337),1280.0,0,0,0,0,0.0))
        result.add(StoreData("스타벅스 가산브이타워점","서울특별시 금천구 가산동 가산디지털1로 128","1522-3232",LatLng(37.477442,126.883845),1340.0,-1,0,0,0,0.0))
        result.add(StoreData("스타벅스 가산그레이트점","서울특별시 금천구 가산동 디지털로9길 32","1522-3232",LatLng(37.480159,126.887293),1510.0,0,0,0,0,0.0))
        result.add(StoreData("스타벅스 가산디지털점","서울특별시 금천구 가산동 371-28”,”1522-3232","1522-3232",LatLng(37.480703,126.882144),1680.0,1,0,0,0,0.7))
